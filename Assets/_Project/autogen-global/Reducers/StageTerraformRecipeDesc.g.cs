...
namespace BitCraft.Global
{
    ...
    {
        public delegate void StageTerraformRecipeDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraft.Global.TerraformRecipeDesc> records);
        public event StageTerraformRecipeDescHandler? OnStageTerraformRecipeDesc;

        public void StageTerraformRecipeDesc(System.Collections.Generic.List<BitCraft.Global.TerraformRecipeDesc> records)
        {
