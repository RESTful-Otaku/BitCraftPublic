...
namespace BitCraft.Global
{
    ...
    {
        public delegate void ImportLocationStateHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraft.Global.LocationState> records);
        public event ImportLocationStateHandler? OnImportLocationState;

        public void ImportLocationState(System.Collections.Generic.List<BitCraft.Global.LocationState> records)
        {
