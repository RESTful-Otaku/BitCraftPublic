...
namespace BitCraft.Global
{
    ...
    {
        public delegate void StageEmpireColorsDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraft.Global.EmpireColorDesc> records);
        public event StageEmpireColorsDescHandler? OnStageEmpireColorsDesc;

        public void StageEmpireColorsDesc(System.Collections.Generic.List<BitCraft.Global.EmpireColorDesc> records)
        {
