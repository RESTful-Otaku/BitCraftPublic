...
namespace BitCraft.Global
{
    ...
    {
        public delegate void ImportElevatorDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraft.Global.ElevatorDesc> records);
        public event ImportElevatorDescHandler? OnImportElevatorDesc;

        public void ImportElevatorDesc(System.Collections.Generic.List<BitCraft.Global.ElevatorDesc> records)
        {
