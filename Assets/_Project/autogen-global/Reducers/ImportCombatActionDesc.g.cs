...
namespace BitCraft.Global
{
    ...
    {
        public delegate void ImportCombatActionDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraft.Global.CombatActionDesc> records);
        public event ImportCombatActionDescHandler? OnImportCombatActionDesc;

        public void ImportCombatActionDesc(System.Collections.Generic.List<BitCraft.Global.CombatActionDesc> records)
        {
