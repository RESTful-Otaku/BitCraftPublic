...
namespace BitCraft.Global
{
    ...
    {
        public delegate void ImportExplorationChunksStateHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraft.Global.ExplorationChunksStateV2> records);
        public event ImportExplorationChunksStateHandler? OnImportExplorationChunksState;

        public void ImportExplorationChunksState(System.Collections.Generic.List<BitCraft.Global.ExplorationChunksStateV2> records)
        {
