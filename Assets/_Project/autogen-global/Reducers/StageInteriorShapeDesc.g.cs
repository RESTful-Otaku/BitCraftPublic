...
namespace BitCraft.Global
{
    ...
    {
        public delegate void StageInteriorShapeDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraft.Global.InteriorShapeDesc> records);
        public event StageInteriorShapeDescHandler? OnStageInteriorShapeDesc;

        public void StageInteriorShapeDesc(System.Collections.Generic.List<BitCraft.Global.InteriorShapeDesc> records)
        {
