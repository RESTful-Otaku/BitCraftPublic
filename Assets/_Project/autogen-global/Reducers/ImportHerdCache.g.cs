...
namespace BitCraft.Global
{
    ...
    {
        public delegate void ImportHerdCacheHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraft.Global.HerdState> records);
        public event ImportHerdCacheHandler? OnImportHerdCache;

        public void ImportHerdCache(System.Collections.Generic.List<BitCraft.Global.HerdState> records)
        {
