...
namespace BitCraft.Global
{
    ...
    {
        public delegate void StageEnemyScalingDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraft.Global.EnemyScalingDesc> records);
        public event StageEnemyScalingDescHandler? OnStageEnemyScalingDesc;

        public void StageEnemyScalingDesc(System.Collections.Generic.List<BitCraft.Global.EnemyScalingDesc> records)
        {
