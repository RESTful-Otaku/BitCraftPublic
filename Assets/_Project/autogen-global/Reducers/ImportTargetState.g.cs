...
namespace BitCraft.Global
{
    ...
    {
        public delegate void ImportTargetStateHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraft.Global.TargetState> records);
        public event ImportTargetStateHandler? OnImportTargetState;

        public void ImportTargetState(System.Collections.Generic.List<BitCraft.Global.TargetState> records)
        {
