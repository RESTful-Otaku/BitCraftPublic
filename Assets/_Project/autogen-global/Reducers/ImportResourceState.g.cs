...
namespace BitCraft.Global
{
    ...
    {
        public delegate void ImportResourceStateHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraft.Global.ResourceState> records);
        public event ImportResourceStateHandler? OnImportResourceState;

        public void ImportResourceState(System.Collections.Generic.List<BitCraft.Global.ResourceState> records)
        {
