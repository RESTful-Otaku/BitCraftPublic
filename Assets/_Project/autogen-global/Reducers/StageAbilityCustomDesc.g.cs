...
namespace BitCraft.Global
{
    ...
    {
        public delegate void StageAbilityCustomDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraft.Global.AbilityCustomDesc> records);
        public event StageAbilityCustomDescHandler? OnStageAbilityCustomDesc;

        public void StageAbilityCustomDesc(System.Collections.Generic.List<BitCraft.Global.AbilityCustomDesc> records)
        {
