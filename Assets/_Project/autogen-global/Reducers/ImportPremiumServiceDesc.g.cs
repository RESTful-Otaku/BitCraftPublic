...
namespace BitCraft.Global
{
    ...
    {
        public delegate void ImportPremiumServiceDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraft.Global.PremiumServiceDesc> records);
        public event ImportPremiumServiceDescHandler? OnImportPremiumServiceDesc;

        public void ImportPremiumServiceDesc(System.Collections.Generic.List<BitCraft.Global.PremiumServiceDesc> records)
        {
