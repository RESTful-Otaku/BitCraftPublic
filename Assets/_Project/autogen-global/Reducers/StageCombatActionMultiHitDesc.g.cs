...
namespace BitCraft.Global
{
    ...
    {
        public delegate void StageCombatActionMultiHitDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraft.Global.CombatActionMultiHitDesc> records);
        public event StageCombatActionMultiHitDescHandler? OnStageCombatActionMultiHitDesc;

        public void StageCombatActionMultiHitDesc(System.Collections.Generic.List<BitCraft.Global.CombatActionMultiHitDesc> records)
        {
