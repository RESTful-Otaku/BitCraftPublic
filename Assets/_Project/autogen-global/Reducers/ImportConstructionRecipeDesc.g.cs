...
namespace BitCraft.Global
{
    ...
    {
        public delegate void ImportConstructionRecipeDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraft.Global.ConstructionRecipeDesc> records);
        public event ImportConstructionRecipeDescHandler? OnImportConstructionRecipeDesc;

        public void ImportConstructionRecipeDesc(System.Collections.Generic.List<BitCraft.Global.ConstructionRecipeDesc> records)
        {
