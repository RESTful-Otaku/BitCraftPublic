...
namespace BitCraft.Global
{
    ...
    {
        public delegate void StageClaimTechDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraft.Global.ClaimTechDesc> records);
        public event StageClaimTechDescHandler? OnStageClaimTechDesc;

        public void StageClaimTechDesc(System.Collections.Generic.List<BitCraft.Global.ClaimTechDesc> records)
        {
