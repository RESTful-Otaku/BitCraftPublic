...
namespace BitCraft.Global
{
    ...
    {
        public delegate void StageElevatorDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraft.Global.ElevatorDesc> records);
        public event StageElevatorDescHandler? OnStageElevatorDesc;

        public void StageElevatorDesc(System.Collections.Generic.List<BitCraft.Global.ElevatorDesc> records)
        {
