...
namespace BitCraft.Global
{
    ...
    {
        public delegate void StageCombatActionDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraft.Global.CombatActionDesc> records);
        public event StageCombatActionDescHandler? OnStageCombatActionDesc;

        public void StageCombatActionDesc(System.Collections.Generic.List<BitCraft.Global.CombatActionDesc> records)
        {
