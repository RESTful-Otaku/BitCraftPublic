...
namespace BitCraft.Global
{
    ...
    {
        public delegate void ImportEmpireIconDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraft.Global.EmpireIconDesc> records);
        public event ImportEmpireIconDescHandler? OnImportEmpireIconDesc;

        public void ImportEmpireIconDesc(System.Collections.Generic.List<BitCraft.Global.EmpireIconDesc> records)
        {
