...
namespace BitCraft.Global
{
    ...
    {
        public delegate void ImportInteriorNetworkDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraft.Global.InteriorNetworkDesc> records);
        public event ImportInteriorNetworkDescHandler? OnImportInteriorNetworkDesc;

        public void ImportInteriorNetworkDesc(System.Collections.Generic.List<BitCraft.Global.InteriorNetworkDesc> records)
        {
