...
namespace BitCraft.Global
{
    ...
    {
        public delegate void ImportKnowledgeNpcStateHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraft.Global.KnowledgeNpcState> records);
        public event ImportKnowledgeNpcStateHandler? OnImportKnowledgeNpcState;

        public void ImportKnowledgeNpcState(System.Collections.Generic.List<BitCraft.Global.KnowledgeNpcState> records)
        {
