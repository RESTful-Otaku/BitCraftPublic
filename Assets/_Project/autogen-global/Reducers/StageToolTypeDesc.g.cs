...
namespace BitCraft.Global
{
    ...
    {
        public delegate void StageToolTypeDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraft.Global.ToolTypeDesc> records);
        public event StageToolTypeDescHandler? OnStageToolTypeDesc;

        public void StageToolTypeDesc(System.Collections.Generic.List<BitCraft.Global.ToolTypeDesc> records)
        {
