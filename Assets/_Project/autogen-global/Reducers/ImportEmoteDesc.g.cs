...
namespace BitCraft.Global
{
    ...
    {
        public delegate void ImportEmoteDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraft.Global.EmoteDesc> records);
        public event ImportEmoteDescHandler? OnImportEmoteDesc;

        public void ImportEmoteDesc(System.Collections.Generic.List<BitCraft.Global.EmoteDesc> records)
        {
