...
namespace BitCraft.Global
{
    ...
    {
        public delegate void ImportLootChestDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraft.Global.LootChestDesc> records);
        public event ImportLootChestDescHandler? OnImportLootChestDesc;

        public void ImportLootChestDesc(System.Collections.Generic.List<BitCraft.Global.LootChestDesc> records)
        {
