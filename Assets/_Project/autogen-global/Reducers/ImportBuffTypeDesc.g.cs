...
namespace BitCraft.Global
{
    ...
    {
        public delegate void ImportBuffTypeDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraft.Global.BuffTypeDesc> records);
        public event ImportBuffTypeDescHandler? OnImportBuffTypeDesc;

        public void ImportBuffTypeDesc(System.Collections.Generic.List<BitCraft.Global.BuffTypeDesc> records)
        {
