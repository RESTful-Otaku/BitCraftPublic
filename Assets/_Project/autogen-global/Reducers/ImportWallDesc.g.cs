...
namespace BitCraft.Global
{
    ...
    {
        public delegate void ImportWallDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraft.Global.WallDesc> records);
        public event ImportWallDescHandler? OnImportWallDesc;

        public void ImportWallDesc(System.Collections.Generic.List<BitCraft.Global.WallDesc> records)
        {
