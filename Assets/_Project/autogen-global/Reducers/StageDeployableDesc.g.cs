...
namespace BitCraft.Global
{
    ...
    {
        public delegate void StageDeployableDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraft.Global.DeployableDesc> records);
        public event StageDeployableDescHandler? OnStageDeployableDesc;

        public void StageDeployableDesc(System.Collections.Generic.List<BitCraft.Global.DeployableDesc> records)
        {
