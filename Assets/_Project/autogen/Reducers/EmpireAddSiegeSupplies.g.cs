...
namespace BitCraft.Spacetime
{
    ...
    {
        public delegate void EmpireAddSiegeSuppliesHandler(ReducerEventContext ctx, BitCraft.Spacetime.EmpireAddSiegeSuppliesRequest request);
        public event EmpireAddSiegeSuppliesHandler? OnEmpireAddSiegeSupplies;

        public void EmpireAddSiegeSupplies(BitCraft.Spacetime.EmpireAddSiegeSuppliesRequest request)
        {
