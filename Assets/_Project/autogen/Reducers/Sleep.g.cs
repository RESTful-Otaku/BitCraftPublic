...
namespace BitCraft.Spacetime
{
    ...
    {
        public delegate void SleepHandler(ReducerEventContext ctx, BitCraft.Spacetime.PlayerSleepRequest request);
        public event SleepHandler? OnSleep;

        public void Sleep(BitCraft.Spacetime.PlayerSleepRequest request)
        {
