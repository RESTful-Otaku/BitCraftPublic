...
namespace BitCraft.Spacetime
{
    ...
    {
        public delegate void GenerateWorldHandler(ReducerEventContext ctx, BitCraft.Spacetime.WorldGenWorldDefinition worldDefinition);
        public event GenerateWorldHandler? OnGenerateWorld;

        public void GenerateWorld(BitCraft.Spacetime.WorldGenWorldDefinition worldDefinition)
        {
