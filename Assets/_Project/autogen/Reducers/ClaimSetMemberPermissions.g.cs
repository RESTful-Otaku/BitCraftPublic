...
namespace BitCraft.Spacetime
{
    ...
    {
        public delegate void ClaimSetMemberPermissionsHandler(ReducerEventContext ctx, BitCraft.Spacetime.PlayerClaimSetMemberPermissionsRequest request);
        public event ClaimSetMemberPermissionsHandler? OnClaimSetMemberPermissions;

        public void ClaimSetMemberPermissions(BitCraft.Spacetime.PlayerClaimSetMemberPermissionsRequest request)
        {
