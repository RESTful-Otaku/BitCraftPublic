...
namespace BitCraft.Spacetime
{
    ...
    {
        public delegate void ImportExplorationChunksStateHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraft.Spacetime.ExplorationChunksStateV2> records);
        public event ImportExplorationChunksStateHandler? OnImportExplorationChunksState;

        public void ImportExplorationChunksState(System.Collections.Generic.List<BitCraft.Spacetime.ExplorationChunksStateV2> records)
        {
