...
namespace BitCraft.Spacetime
{
    ...
    {
        public delegate void ClaimRemoveRecruitmentHandler(ReducerEventContext ctx, BitCraft.Spacetime.PlayerClaimRemoveRecruitmentRequest request);
        public event ClaimRemoveRecruitmentHandler? OnClaimRemoveRecruitment;

        public void ClaimRemoveRecruitment(BitCraft.Spacetime.PlayerClaimRemoveRecruitmentRequest request)
        {
