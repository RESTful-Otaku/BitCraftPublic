...
namespace BitCraft.Spacetime
{
    ...
    {
        public delegate void StageLootRarityDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraft.Spacetime.LootRarityDesc> records);
        public event StageLootRarityDescHandler? OnStageLootRarityDesc;

        public void StageLootRarityDesc(System.Collections.Generic.List<BitCraft.Spacetime.LootRarityDesc> records)
        {
