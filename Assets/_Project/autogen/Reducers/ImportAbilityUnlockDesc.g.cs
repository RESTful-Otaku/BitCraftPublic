...
namespace BitCraft.Spacetime
{
    ...
    {
        public delegate void ImportAbilityUnlockDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraft.Spacetime.AbilityUnlockDesc> records);
        public event ImportAbilityUnlockDescHandler? OnImportAbilityUnlockDesc;

        public void ImportAbilityUnlockDesc(System.Collections.Generic.List<BitCraft.Spacetime.AbilityUnlockDesc> records)
        {
