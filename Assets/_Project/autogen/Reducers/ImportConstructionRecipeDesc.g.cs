...
namespace BitCraft.Spacetime
{
    ...
    {
        public delegate void ImportConstructionRecipeDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraft.Spacetime.ConstructionRecipeDesc> records);
        public event ImportConstructionRecipeDescHandler? OnImportConstructionRecipeDesc;

        public void ImportConstructionRecipeDesc(System.Collections.Generic.List<BitCraft.Spacetime.ConstructionRecipeDesc> records)
        {
