...
namespace BitCraft.Spacetime
{
    ...
    {
        public delegate void ClaimTakeOwnershipHandler(ReducerEventContext ctx, BitCraft.Spacetime.PlayerClaimTakeOwnershipRequest request);
        public event ClaimTakeOwnershipHandler? OnClaimTakeOwnership;

        public void ClaimTakeOwnership(BitCraft.Spacetime.PlayerClaimTakeOwnershipRequest request)
        {
