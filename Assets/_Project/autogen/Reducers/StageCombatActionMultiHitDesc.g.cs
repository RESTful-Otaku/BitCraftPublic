...
namespace BitCraft.Spacetime
{
    ...
    {
        public delegate void StageCombatActionMultiHitDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraft.Spacetime.CombatActionMultiHitDesc> records);
        public event StageCombatActionMultiHitDescHandler? OnStageCombatActionMultiHitDesc;

        public void StageCombatActionMultiHitDesc(System.Collections.Generic.List<BitCraft.Spacetime.CombatActionMultiHitDesc> records)
        {
