...
namespace BitCraft.Spacetime
{
    ...
    {
        public delegate void StageEmpireColorsDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraft.Spacetime.EmpireColorDesc> records);
        public event StageEmpireColorsDescHandler? OnStageEmpireColorsDesc;

        public void StageEmpireColorsDesc(System.Collections.Generic.List<BitCraft.Spacetime.EmpireColorDesc> records)
        {
