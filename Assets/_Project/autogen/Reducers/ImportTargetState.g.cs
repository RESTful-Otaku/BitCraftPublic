...
namespace BitCraft.Spacetime
{
    ...
    {
        public delegate void ImportTargetStateHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraft.Spacetime.TargetState> records);
        public event ImportTargetStateHandler? OnImportTargetState;

        public void ImportTargetState(System.Collections.Generic.List<BitCraft.Spacetime.TargetState> records)
        {
