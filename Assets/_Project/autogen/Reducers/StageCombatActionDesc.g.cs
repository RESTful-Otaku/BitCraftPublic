...
namespace BitCraft.Spacetime
{
    ...
    {
        public delegate void StageCombatActionDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraft.Spacetime.CombatActionDesc> records);
        public event StageCombatActionDescHandler? OnStageCombatActionDesc;

        public void StageCombatActionDesc(System.Collections.Generic.List<BitCraft.Spacetime.CombatActionDesc> records)
        {
