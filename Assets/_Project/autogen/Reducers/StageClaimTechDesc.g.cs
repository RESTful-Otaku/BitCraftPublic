...
namespace BitCraft.Spacetime
{
    ...
    {
        public delegate void StageClaimTechDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraft.Spacetime.ClaimTechDesc> records);
        public event StageClaimTechDescHandler? OnStageClaimTechDesc;

        public void StageClaimTechDesc(System.Collections.Generic.List<BitCraft.Spacetime.ClaimTechDesc> records)
        {
