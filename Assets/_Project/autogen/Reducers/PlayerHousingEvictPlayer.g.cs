...
namespace BitCraft.Spacetime
{
    ...
    {
        public delegate void PlayerHousingEvictPlayerHandler(ReducerEventContext ctx, BitCraft.Spacetime.PlayerHousingEvictPlayerRequest request);
        public event PlayerHousingEvictPlayerHandler? OnPlayerHousingEvictPlayer;

        public void PlayerHousingEvictPlayer(BitCraft.Spacetime.PlayerHousingEvictPlayerRequest request)
        {
