...
namespace BitCraft.Spacetime
{
    ...
    {
        public delegate void ImportElevatorDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraft.Spacetime.ElevatorDesc> records);
        public event ImportElevatorDescHandler? OnImportElevatorDesc;

        public void ImportElevatorDesc(System.Collections.Generic.List<BitCraft.Spacetime.ElevatorDesc> records)
        {
