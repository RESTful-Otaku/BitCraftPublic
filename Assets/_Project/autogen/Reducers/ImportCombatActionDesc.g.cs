...
namespace BitCraft.Spacetime
{
    ...
    {
        public delegate void ImportCombatActionDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraft.Spacetime.CombatActionDesc> records);
        public event ImportCombatActionDescHandler? OnImportCombatActionDesc;

        public void ImportCombatActionDesc(System.Collections.Generic.List<BitCraft.Spacetime.CombatActionDesc> records)
        {
