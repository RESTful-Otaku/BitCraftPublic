...
namespace BitCraft.Spacetime
{
    ...
    {
        public delegate void StageToolTypeDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraft.Spacetime.ToolTypeDesc> records);
        public event StageToolTypeDescHandler? OnStageToolTypeDesc;

        public void StageToolTypeDesc(System.Collections.Generic.List<BitCraft.Spacetime.ToolTypeDesc> records)
        {
