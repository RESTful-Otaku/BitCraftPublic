...
namespace BitCraft.Spacetime
{
    ...
    {
        public delegate void PlayerClearActionStateHandler(ReducerEventContext ctx, ulong actorId, BitCraft.Spacetime.PlayerActionType currentAction, BitCraft.Spacetime.PlayerActionLayer layer, BitCraft.Spacetime.PlayerActionResult lastActionResult);
        public event PlayerClearActionStateHandler? OnPlayerClearActionState;

        public void PlayerClearActionState(ulong actorId, BitCraft.Spacetime.PlayerActionType currentAction, BitCraft.Spacetime.PlayerActionLayer layer, BitCraft.Spacetime.PlayerActionResult lastActionResult)
        {
