...
namespace BitCraft.Spacetime
{
    ...
    {
        public delegate void BuildingRepairHandler(ReducerEventContext ctx, BitCraft.Spacetime.PlayerBuildingRepairRequest request);
        public event BuildingRepairHandler? OnBuildingRepair;

        public void BuildingRepair(BitCraft.Spacetime.PlayerBuildingRepairRequest request)
        {
