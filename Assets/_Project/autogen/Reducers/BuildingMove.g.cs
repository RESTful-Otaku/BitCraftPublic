...
namespace BitCraft.Spacetime
{
    ...
    {
        public delegate void BuildingMoveHandler(ReducerEventContext ctx, BitCraft.Spacetime.PlayerBuildingMoveRequest request);
        public event BuildingMoveHandler? OnBuildingMove;

        public void BuildingMove(BitCraft.Spacetime.PlayerBuildingMoveRequest request)
        {
