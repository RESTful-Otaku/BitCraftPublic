...
namespace BitCraft.Spacetime
{
    ...
    {
        public delegate void ImportBuffTypeDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraft.Spacetime.BuffTypeDesc> records);
        public event ImportBuffTypeDescHandler? OnImportBuffTypeDesc;

        public void ImportBuffTypeDesc(System.Collections.Generic.List<BitCraft.Spacetime.BuffTypeDesc> records)
        {
