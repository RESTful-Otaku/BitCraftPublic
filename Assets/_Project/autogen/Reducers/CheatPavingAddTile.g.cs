...
namespace BitCraft.Spacetime
{
    ...
    {
        public delegate void CheatPavingAddTileHandler(ReducerEventContext ctx, BitCraft.Spacetime.PlayerPavingPlaceTileRequest request);
        public event CheatPavingAddTileHandler? OnCheatPavingAddTile;

        public void CheatPavingAddTile(BitCraft.Spacetime.PlayerPavingPlaceTileRequest request)
        {
