...
namespace BitCraft.Spacetime
{
    ...
    {
        public delegate void ImportResourceStateHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraft.Spacetime.ResourceState> records);
        public event ImportResourceStateHandler? OnImportResourceState;

        public void ImportResourceState(System.Collections.Generic.List<BitCraft.Spacetime.ResourceState> records)
        {
