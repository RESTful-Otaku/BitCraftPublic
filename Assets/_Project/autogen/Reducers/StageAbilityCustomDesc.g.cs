...
namespace BitCraft.Spacetime
{
    ...
    {
        public delegate void StageAbilityCustomDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraft.Spacetime.AbilityCustomDesc> records);
        public event StageAbilityCustomDescHandler? OnStageAbilityCustomDesc;

        public void StageAbilityCustomDesc(System.Collections.Generic.List<BitCraft.Spacetime.AbilityCustomDesc> records)
        {
