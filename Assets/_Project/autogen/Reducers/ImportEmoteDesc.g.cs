...
namespace BitCraft.Spacetime
{
    ...
    {
        public delegate void ImportEmoteDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraft.Spacetime.EmoteDesc> records);
        public event ImportEmoteDescHandler? OnImportEmoteDesc;

        public void ImportEmoteDesc(System.Collections.Generic.List<BitCraft.Spacetime.EmoteDesc> records)
        {
