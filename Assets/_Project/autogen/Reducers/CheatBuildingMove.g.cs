...
namespace BitCraft.Spacetime
{
    ...
    {
        public delegate void CheatBuildingMoveHandler(ReducerEventContext ctx, BitCraft.Spacetime.PlayerBuildingMoveRequest request);
        public event CheatBuildingMoveHandler? OnCheatBuildingMove;

        public void CheatBuildingMove(BitCraft.Spacetime.PlayerBuildingMoveRequest request)
        {
