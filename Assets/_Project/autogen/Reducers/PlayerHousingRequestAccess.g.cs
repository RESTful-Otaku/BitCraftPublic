...
namespace BitCraft.Spacetime
{
    ...
    {
        public delegate void PlayerHousingRequestAccessHandler(ReducerEventContext ctx, BitCraft.Spacetime.PlayerHousingRequestAccessRequest request);
        public event PlayerHousingRequestAccessHandler? OnPlayerHousingRequestAccess;

        public void PlayerHousingRequestAccess(BitCraft.Spacetime.PlayerHousingRequestAccessRequest request)
        {
