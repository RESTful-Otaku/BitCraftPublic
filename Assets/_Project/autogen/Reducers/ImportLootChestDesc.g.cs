...
namespace BitCraft.Spacetime
{
    ...
    {
        public delegate void ImportLootChestDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraft.Spacetime.LootChestDesc> records);
        public event ImportLootChestDescHandler? OnImportLootChestDesc;

        public void ImportLootChestDesc(System.Collections.Generic.List<BitCraft.Spacetime.LootChestDesc> records)
        {
