...
namespace BitCraft.Spacetime
{
    ...
    {
        public delegate void ImportHerdCacheHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraft.Spacetime.HerdState> records);
        public event ImportHerdCacheHandler? OnImportHerdCache;

        public void ImportHerdCache(System.Collections.Generic.List<BitCraft.Spacetime.HerdState> records)
        {
