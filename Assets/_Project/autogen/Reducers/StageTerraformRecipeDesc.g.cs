...
namespace BitCraft.Spacetime
{
    ...
    {
        public delegate void StageTerraformRecipeDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraft.Spacetime.TerraformRecipeDesc> records);
        public event StageTerraformRecipeDescHandler? OnStageTerraformRecipeDesc;

        public void StageTerraformRecipeDesc(System.Collections.Generic.List<BitCraft.Spacetime.TerraformRecipeDesc> records)
        {
