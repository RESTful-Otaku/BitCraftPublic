...
namespace BitCraft.Spacetime
{
    ...
    {
        public delegate void ImportEmpireIconDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraft.Spacetime.EmpireIconDesc> records);
        public event ImportEmpireIconDescHandler? OnImportEmpireIconDesc;

        public void ImportEmpireIconDesc(System.Collections.Generic.List<BitCraft.Spacetime.EmpireIconDesc> records)
        {
