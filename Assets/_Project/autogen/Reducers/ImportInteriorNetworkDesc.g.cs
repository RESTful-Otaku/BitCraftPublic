...
namespace BitCraft.Spacetime
{
    ...
    {
        public delegate void ImportInteriorNetworkDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraft.Spacetime.InteriorNetworkDesc> records);
        public event ImportInteriorNetworkDescHandler? OnImportInteriorNetworkDesc;

        public void ImportInteriorNetworkDesc(System.Collections.Generic.List<BitCraft.Spacetime.InteriorNetworkDesc> records)
        {
