...
namespace BitCraft.Spacetime
{
    ...
    {
        public delegate void StageElevatorDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraft.Spacetime.ElevatorDesc> records);
        public event StageElevatorDescHandler? OnStageElevatorDesc;

        public void StageElevatorDesc(System.Collections.Generic.List<BitCraft.Spacetime.ElevatorDesc> records)
        {
