...
namespace BitCraft.Spacetime
{
    ...
    {
        public delegate void ImportKnowledgeNpcStateHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraft.Spacetime.KnowledgeNpcState> records);
        public event ImportKnowledgeNpcStateHandler? OnImportKnowledgeNpcState;

        public void ImportKnowledgeNpcState(System.Collections.Generic.List<BitCraft.Spacetime.KnowledgeNpcState> records)
        {
