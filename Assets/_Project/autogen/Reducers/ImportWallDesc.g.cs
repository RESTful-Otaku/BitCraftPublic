...
namespace BitCraft.Spacetime
{
    ...
    {
        public delegate void ImportWallDescHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraft.Spacetime.WallDesc> records);
        public event ImportWallDescHandler? OnImportWallDesc;

        public void ImportWallDesc(System.Collections.Generic.List<BitCraft.Spacetime.WallDesc> records)
        {
