...
namespace BitCraft.Spacetime
{
    ...
    {
        public delegate void ClaimSetPurchaseSupplyThresholdHandler(ReducerEventContext ctx, BitCraft.Spacetime.ClaimSetPurchaseSupplyThresholdRequest request);
        public event ClaimSetPurchaseSupplyThresholdHandler? OnClaimSetPurchaseSupplyThreshold;

        public void ClaimSetPurchaseSupplyThreshold(BitCraft.Spacetime.ClaimSetPurchaseSupplyThresholdRequest request)
        {
