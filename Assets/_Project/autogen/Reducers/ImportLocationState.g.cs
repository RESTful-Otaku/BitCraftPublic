...
namespace BitCraft.Spacetime
{
    ...
    {
        public delegate void ImportLocationStateHandler(ReducerEventContext ctx, System.Collections.Generic.List<BitCraft.Spacetime.LocationState> records);
        public event ImportLocationStateHandler? OnImportLocationState;

        public void ImportLocationState(System.Collections.Generic.List<BitCraft.Spacetime.LocationState> records)
        {
